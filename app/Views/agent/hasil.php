...
<div class="main-section hasil-section text-center">
  ...
  <tr>
    <th>Jumlah Soal</th>
    <td><?= esc($hasil['jumlah_soal'] ?? 0) ?></td>
  </tr>
  <tr>
    <th>Jawaban Benar</th>
    <td><?= esc($hasil['jawaban_benar'] ?? 0) ?></td>
  </tr>
  <tr>
    <th>Jawaban Salah</th>
    <td><?= esc($hasil['jawaban_salah'] ?? 0) ?></td>
  </tr>
  <tr class="fw-bold">
    <th>Total Skor</th>
    <td><?= esc($hasil['total_skor'] ?? 0) ?></td>
  </tr>
</table>


    <div class="hasil-buttons">
      <a href="<?= base_url('agent/hasil/detail/'.$hasil['id_hasil']) ?>" class="btn-detail">Lihat Detail</a>
