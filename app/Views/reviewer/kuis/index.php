...
<div class="content">
  ...
  <div class="actions">
    <a href="<?= base_url('reviewer/kuis/create') ?>" class="btn btn-blue">+ Tambah Kuis</a>
  </div>
        ...
        <tr data-kuis-id="<?= esc($row['id_kuis']) ?>">
          ...
          <td class="action-buttons">
            <?php if ($row['status'] === 'draft'): ?>
              <a href="<?= base_url('reviewer/kuis/upload/' . $row['id_kuis']) ?>"
            ...
            <?php else: ?>
              <a href="<?= base_url('reviewer/kuis/edit/' . $row['id_kuis']) ?>" class="btn btn-green btn-sm btn-edit">EDIT</a>
            <?php endif; ?>

            <a href="<?= base_url('reviewer/kuis/delete/' . $row['id_kuis']) ?>" class="btn btn-red btn-sm"
               onclick="return confirm('Yakin hapus kuis ini?')">HAPUS</a>
            <a href="<?= base_url('reviewer/kuis/archive/' . $row['id_kuis']) ?>" class="btn btn-dark btn-sm">ARCHIVE</a>
          </td>
        </tr>
        <?php endforeach; ?>
      <?php else: ?>
...
document.addEventListener("DOMContentLoaded", function () {
  const ENDPOINT     = "<?= base_url('reviewer/kuis/pollStatus') ?>";
  const UPLOAD_BASE  = "<?= base_url('reviewer/kuis/upload') ?>";
